...
def get_llm_response(context: str, query: str) -> str:
    ...
    Args:
        ...
        query (str): The user's question to be answered based on the contenxt.

    Returns:
        str: The assistant's generated text response.

    Raises:
        ValueError: If the Gemini Environment variable is not set.
    """
        ...
        system_instruction=[
            types.Part.from_text(
                text=(
                    ...
                    "personal opinions and information in your responses.\n\n"
                    f"Context:\n```{context}```"
                )
            ),
        ],
